            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Resgistros de Contrato</h3>

                        <div class="card-tools">
                            <div class="input-group input-group-sm">
                                <router-link to="/contracts/new">
                                <button class="btn btn-success" >Novo <i class="fas fa-user-plus"></i> </button>
                                </router-link>
                            </div>
                        </div>
                    </div >
...
<script>
    export default {
        ...
        methods : {
            loadContracts(){
                //axios.get("api/contract").then(({ data }) => (this.contracts = data.data));
            },
