...
let routes = [
    ...
    { path: '/contracts/new', component: require('./components/ContractsNew.vue') },
    { path: '/contracts/view', component: require('./components/ContractsView.vue') },
    { path: '/companies', component: require('./components/Companies.vue') },
    { path: '/developer', component: require('./components/Developer.vue') },
    { path: '/invoices', component: require('./components/Invoices.vue') },
];
